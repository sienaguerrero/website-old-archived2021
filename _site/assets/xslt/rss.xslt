                  ...
                  <li class="has-dropdown">
                    <a  href="http://localhost:4000/articles/">Articles</a>
                      <ul class="dropdown">
                            ...
                            <li><a  href="/_posts/my-computer-setup/">My Cmputer Setup</a></li>
        ...
        <div class="row">
          <div class="medium-6 large-5 columns">
            ...
            <p class="shadow-black">
              ...
              Hosted on Github Pages, maintained on Github.
            </p>
          </div><!-- /.large-6.columns -->
          ...
          <div class="small-6 medium-3 large-3 columns">
            ...
            <ul class="no-bullet shadow-black">
                ...
                <li class="sitemap-link" >
                  <a href="http://srobbin.com/jquery-plugins/backstretch/" target="_blank"  title="Backstretch by Scott Robbin">Using Backstretch by Scott Robbin</a>
                </li>
